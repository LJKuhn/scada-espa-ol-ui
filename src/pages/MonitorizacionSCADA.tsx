...
import { Factory, AlertTriangle, Activity, Clock, Zap, Thermometer, Gauge, TrendingUp } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Supervisión en tiempo real de todas las plantas y fábricas
        </p>
      </div>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isSelected
                      ...
                      : "scada-panel border-border hover:border-primary/50"
                  )}
                >
          ...
          <Card className="bg-card border-border">
            <CardContent className="p-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <Badge
                  variant="outline"
                  className={getEstadoConfig(selectedPlanta.estado).badgeClass}
                >
                  <div
                    className={cn(
                      "status-dot mr-2",
                      getEstadoConfig(selectedPlanta.estado).dotClass
                    )}
                  />
            ...
            <Card className="bg-card border-border">
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <Progress
                    value={selectedPlanta.produccion}
                    className="h-2"
                  />
            ...
            <Card className="bg-card border-border">
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-end justify-between">
                    <span className="text-3xl font-bold text-foreground font-mono">
                      {selectedPlanta.eficiencia}%
                    </span>
                    <span className="text-sm text-muted-foreground">OEE</span>
                  </div>
                  <Progress
                    value={selectedPlanta.eficiencia}
                    className="h-2"
                  />
            ...
            <Card className="bg-card border-border">
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-end justify-between">
                    <span
                      className={cn(
                        ...
                        selectedPlanta.temperatura > 60
                          ? "text-destructive"
                          : selectedPlanta.temperatura > 50
                          ? "text-warning"
                          : "text-foreground"
                      )}
                    >
                  ...
                  <Progress
                    value={(selectedPlanta.temperatura / 80) * 100}
                    className={cn(
                      "h-2",
                      selectedPlanta.temperatura > 60 && "[&>div]:bg-destructive"
                    )}
                  />
                </div>
              </CardContent>
            ...
            <Card className="bg-card border-border">
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-end justify-between">
                    <span className="text-3xl font-bold text-foreground font-mono">
                      {selectedPlanta.consumoEnergia.toLocaleString()}
                    </span>
              ...
              <CardHeader className="pb-2">
                <CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2">
                  <AlertTriangle
                    className={cn(
                      "h-4 w-4",
                      selectedPlanta.alarmasActivas > 0 && "text-destructive"
                    )}
                  />
                  Alarmas Activas
                </CardTitle>
