...
const alarmasIniciales: Alarma[] = [
  {
    id: "ALM-001",
    planta: "Planta Norte",
    sensorMaquina: "Sensor Temp. Horno 1",
    descripcion: "Temperatura excede límite superior (75°C)",
    severidad: "alta",
  ...
  },
  {
    ...
    sensorMaquina: "Bomba Principal P1",
    descripcion: "Vibración anormal detectada",
    severidad: "media",
    fechaHora: "2024-01-15 13:45:22",
    estado: "abierta",
  },
  {
    id: "ALM-003",
    planta: "Fábrica Este",
    sensorMaquina: "PLC Control Central",
    descripcion: "Pérdida de comunicación intermitente",
    severidad: "alta",
    fechaHora: "2024-01-15 12:18:00",
    estado: "cerrada",
  },
  {
    id: "ALM-004",
    planta: "Planta Sur",
    sensorMaquina: "Sensor Presión Tanque A",
    descripcion: "Presión por debajo del umbral mínimo",
    severidad: "baja",
    fechaHora: "2024-01-15 11:55:33",
    estado: "abierta",
  },
  {
    id: "ALM-005",
    planta: "Planta Norte",
    sensorMaquina: "Motor Línea 2",
    descripcion: "Consumo eléctrico elevado",
    severidad: "media",
    fechaHora: "2024-01-15 10:22:15",
    estado: "cerrada",
  },
  {
    id: "ALM-006",
    planta: "Fábrica Oeste",
    sensorMaquina: "Válvula Reguladora V3",
    descripcion: "Fallo en actuador de válvula",
    severidad: "alta",
    fechaHora: "2024-01-15 09:08:47",
    estado: "abierta",
  },
];
...
const GestionAlarmas = () => {
  ...
  const alarmasFiltradas = alarmas.filter((alarma) => {
    ...
    const matchesSeveridad =
      filtroSeveridad === "todas" || alarma.severidad === filtroSeveridad;
    const matchesEstado =
      filtroEstado === "todas" || alarma.estado === filtroEstado;
  ...
  const toggleEstado = (id: string) => {
    setAlarmas(
      alarmas.map((a) =>
        a.id === id
          ? { ...a, estado: a.estado === "abierta" ? "cerrada" : "abierta" }
          : a
      )
    );
  };
  ...
  const alarmasAltas = alarmas.filter(
    (a) => a.severidad === "alta" && a.estado === "abierta"
  ).length;
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Monitorea y gestiona las alarmas del sistema
        </p>
      </div>
                ...
                {alarmasFiltradas.map((alarma) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <Badge
                        variant="outline"
                        className={getSeveridadConfig(alarma.severidad).className}
                      >
                    ...
                    <TableCell>
                      <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => toggleEstado(alarma.id)}
                      >
                        {alarma.estado === "abierta" ? (
